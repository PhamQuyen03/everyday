...
//     if (key === 'shared') {
//         const {
//             filters: { service, amenities, districts, fitnessTypes, timeRanges },
//             language, userLocation: { data } = {},
//         } = partialState;

//         const fitnessTypesByService = _.map(fitnessTypes, fitnessType => ({
//             service_type: { name: 'fst' }, ...fitnessType,
//         }));
...
//             ...partialState,
//             filters: {
//                 service: service || { name: 'fst' },
//                 amenities: Amenity.buildArray(amenities),
//                 districts: District.buildArray(districts),
//                 fitnessTypes: FitnessType.buildArray(fitnessTypesByService),
...
export default function createStorePersistor(store) {
    ...
    const configs = {
        // blacklist: ['appRouter', 'mainRouter', 'rootRouter'],
